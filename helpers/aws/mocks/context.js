...
class Context {
  constructor () {
    ...
    this.logGroupName = '/aws/lambda/postman-stage'
    this.logStreamName = '2018/07/05/[$LATEST]2a0e75e4c6844e94a436fac49f781cba'
    this.functionName = 'postman-stage'
    ...
    this.invokedFunctionArn = 'arn =aws =lambda =sa-east-1 =240167814999 =function =postman-stage'
